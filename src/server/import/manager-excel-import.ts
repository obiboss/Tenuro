...
export async function buildManagerImportTemplate() {
  ...
  instructions.addRows([
    ...
    [
      "Tenant details are optional for vacant units. If a tenant is included, phone number, tenancy start date and next rent due date are required.",
    ],
    [
