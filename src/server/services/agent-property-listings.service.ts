  ...
  await writeSystemPropertyListingAuditLog({
    ...
    metadata: {
      ...
      final: {
        ...
        rent_frequency: approvedListing.rent_frequency,
        rent_amount: approvedListing.rent_amount,
...
export async function completeLandlordClaimSignup(params: {
  ...
  const unit = await createUnit(adminSupabase, {
    ...
    bedrooms: listing.bedrooms,
    bathrooms: listing.bathrooms,
    rentFrequency: listing.rent_frequency,
    rentAmount: Number(listing.rent_amount),
