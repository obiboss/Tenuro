...
export function PublicManagerTenantOnboardingForm({
    ...
    return (
      <div className="rounded-card border border-border-soft bg-white p-5 shadow-sm">
        ...
        <p className="mt-2 text-sm font-semibold leading-6 text-text-muted">
          Your details have been sent to the property manager for review.
        </p>
      </div>
    );
  }
  ...
  return (
    <form
      action={formAction}
      className="rounded-card border border-border-soft bg-white p-5 shadow-sm"
    >
