...
type DeveloperBulkPlotUpdateFormProps = {
  estateId: string;
  selectedPlotIds: string[];
};

export function DeveloperBulkPlotUpdateForm({
  estateId,
  selectedPlotIds,
}: DeveloperBulkPlotUpdateFormProps) {
      ...
      <Card>
        <CardContent>
          ...
          <div className="rounded-button bg-primary-soft p-4 text-sm font-semibold leading-6 text-primary">
            {selectedCount === 0
              ? "Select one or more plots above, then set the changes you want BOPA to apply."
              : selectedCount === 1
          ...
          <div className="grid gap-5 md:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <option value="available">Yes, make them available</option>
                <option value="blocked">No, block them for now</option>
              </select>
