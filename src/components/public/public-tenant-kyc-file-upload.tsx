...
type PublicTenantKycDocumentType =
  | "tenant_id_document"
...
type PublicTenantKycFileUploadProps = {
...
export function PublicTenantKycFileUpload({
  agentPropertyListingId,
  documentType,
  label,
  name,
  required,
  helperText,
  error,
}: PublicTenantKycFileUploadProps) {
  ...
  async function handleFileChange(event: React.ChangeEvent<HTMLInputElement>) {
    ...
    try {
      ...
      formData.append("agentPropertyListingId", agentPropertyListingId);
